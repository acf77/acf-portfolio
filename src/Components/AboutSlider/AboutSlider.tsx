  ...
  render() {
    ...
    return (
      <div>
        <Slider {...settings}>
          <div>
            <SlideCard alt='' repoLink="https://github.com/acf77/alptext-ts" image="https://user-images.githubusercontent.com/61336548/119431014-2e4a7c00-bce8-11eb-8e2d-64be0c2a7a99.png" />
